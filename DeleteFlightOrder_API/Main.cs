/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘DeleteFlightOrder_API.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><DeleteFlightOrder xmlns=""HP.SOAQ.SampleApp""><OrderNumber>{Step.InputProperties.StServiceCallActivity4.Body.GetFlightOrders.FlightsDetails.OrderNumber}</OrderNumber></DeleteFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi7 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrders'][1]/*[local-name(.)='FlightsDetails'][1]/*[local-name(.)='OrderNumber'][1]");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><DeleteFlightOrderResponse xmlns=""HP.SOAQ.SampleApp"" /></Body></Envelope>");
            ...
            _flow.ConcatenateStringsActivity6.Prefix = @"Hi, ";
            _flow.ConcatenateStringsActivity6.Suffix = @"This flight order is deleted";
