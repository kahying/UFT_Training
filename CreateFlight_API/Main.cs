/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘CreateFlight_API.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"">
  <Body>
    <GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Frankfurt</DepartureCity><ArrivalCity>Paris</ArrivalCity><FlightDate>2021-04-23T00:00:00+00:00</FlightDate></GetFlights>
  </Body>
</Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>Kah Ying</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity6.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity6.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>3</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            bind_dir2 = new BindDirection(_flow.StServiceCallActivity6,binding_getter2,binding_setter2,BindTargetType.ToInProperty);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><CreateFlightOrderResponse xmlns=""HP.SOAQ.SampleApp""><CreateFlightOrderResult><OrderNumber>80</OrderNumber></CreateFlightOrderResult></CreateFlightOrderResponse></Body></Envelope>");
            ...
            _flow.ConcatenateStringsActivity7.Prefix = @"Hi, The order is created number";
            _flow.ConcatenateStringsActivity7.Suffix = @"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}";
            ...
            binding_setter3 = new StringFormaterDecorator(binding_setter3,"{Step.OutputProperties.StServiceCallActivity5.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}");
            bind_dir3 = new BindDirection(_flow.StServiceCallActivity5,binding_getter3,binding_setter3,BindTargetType.ToInProperty);
            _flow.ConcatenateStringsActivity7.InDirections.Add(bind_dir3);
